{ inputs, ... }: {
  ...
  programs.nvf = {
    ...
    settings.vim = {
      maps = {
        normal."<leader><Left>" = { silent = true; action = "<cmd>bprev<CR>"; };
        normal."<leader><Right>" = { silent = true; action = "<cmd>bnext<CR>"; };
      };
      viAlias = true;
      vimAlias = true;
      ...
      visuals = {
        ...
        cursorline = { enable = true; lineTimeout = 0; };
      };

      # Statusline & Theme
      statusline = { lualine = { enable = true; theme = "catppuccin"; }; };
      ...
      utility = {
        ...
        motion = { hop.enable = true; leap.enable = true; };
      };
      ...
      assistant = { chatgpt.enable = false; copilot.enable = false; };
