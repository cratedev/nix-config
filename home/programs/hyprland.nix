  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      exec-once = [
        ...
        "nm-applet &"
        "echo pwd > test.txt &"
        "hyprpaper nix-config/wallpaper/1.png &"
        "hyprctl setcursor Nordzy-cursors 22 &"
        "hyprpanel &"
        "wl-paste --type text --watch cliphist store &"
        "wl-paste --type image --watch cliphist store &"
        "sleep 1 && hyprctl keyword general:col.active_border 'rgba(6E9CB3FF)' &"
        "sleep 1 && hyprctl keyword general:col.inactive_border 'rgba(45616FFF)' &"
      ];
      ...
      general = {
        ...
        gaps_out = 20;
        border_size = 2;
        #"col.active_border" = lib.mkDefault "0x575575888";
      ...
      bind = [
        ...
        # keybindings
        "$mainMod, Return, exec, ghostty -e zellij attach --create main"
        ...
        "$mainMod, D, exec, rofi -show drun -theme .config/rofi/launchers/type-1/style-6.rasi"
